...
public class EmployeeRepository {
  ...
  public void update(Employee employee) {
    ...
    if (employee.getId() == null) {
      String insertSql = "INSERT INTO employees(name,image,gender,hire_date,mail_address,zip_code,address,telephone,salary,characteristics,dependents_count) + VALUES(:name,:image,:gender,:hireDate,:mailAddress,:zipCode,:address,:telephone,:salary,:characteristics,:dependentsCount)";
